...
JPEGDir = r"D:\@@@\@Creating Dataset\Auto_Labelling_Darknet\JPEGImages"
AnnoDir = r"D:\@@@\@Creating Dataset\Auto_Labelling_Darknet\Annotations"
...
def load_model():
	...
	vehicle_net = cv2.dnn.readNet("./model/ballv8n.onnx")
...
if __name__ == '__main__':
	...
	for input_image in ls_images:
		...
		h,w, _ = resized.shape
		cv2.imshow("original", cv2.resize(resized, (int(w/2), int(h/2))))
		cv2.waitKey(1)
		print(inputFilename)
		endTime = time.time()
