...
def main():
    ...
    parser.add_argument("-xml", default='./xml', help="Relative location of xml files directory", required=True)
    parser.add_argument("-out", default='./out', help="Relative location of output txt files directory", required=True)
    parser.add_argument("-c", default="classes.txt", help="Relative path to classes file")
